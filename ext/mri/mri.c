...
#if RUBY_VERSION >= 230
  Looksee_method_table_foreach(RCLASS_M_TBL(klass)->st, add_method_if_matching, (struct rb_id_table*)&arg);
#else
...
#if RUBY_VERSION >= 230
  Looksee_method_table_foreach(RCLASS_M_TBL(klass)->st, add_method_if_undefined, (struct rb_id_table*)&names);
#else
